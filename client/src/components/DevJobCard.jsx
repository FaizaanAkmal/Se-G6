...
const DevJobCard = ({
  ...
  const [offerAccepted, setOfferAccepted] = useState(
    offeredJobs.some(
      (offeredJob) => offeredJob._id === job._id && offeredJob.offerAccepted
    )
  );
  const [offerRejected, setOfferRejected] = useState(
    offeredJobs.some(
      (offeredJob) => offeredJob._id === job._id && offeredJob.offerRejected
    )
  );
                    ...
                    <Stack direction="row" spacing={2} alignItems={"center"}>
                      ...
                      {applied &&
                        ...
                        !offerRejected && (
                          <Typography
                            ...
                            startDecorator={
                              <img src={appliedIcon} width={"20px"} />
                            }
                          >
                            Applied
                          </Typography>
                      ...
                      {pendingOffer && (
                        <Typography
                          ...
                          sx={{ color: "#F79009" }}
                          startDecorator={
                            <img src={offerPendingIcon} width={"20px"} />
                          }
                        >
                          Offered
                        </Typography>
