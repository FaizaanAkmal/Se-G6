...
export default function DevIndividualJob() {
  ...
  const [pendingOffer, setPendingOffer] = useState(
    location.state.pendingOffer || false
  );
  const [offerAccepted, setOfferAccepted] = useState(
    location.state.offerAccepted || false
  );
  const [offerRejected, setOfferRejected] = useState(
    location.state.offerRejected || false
  );
  const [isBookmarked, setIsBookmarked] = useState(
    location.state.isBookmarked || null
  );
          ...
          >
            <Stack spacing={"20px"}>
              ...
              <Stack direction="row" spacing={2.5} alignItems={"center"}>
                {/* Company Name */}
                <Typography level="title-lg">{job.postedBy.name}</Typography>
                ...
                <IconButton onClick={handleBookmarkToggle}>
                  <img
                    src={
                      isBookmarked ? bookmarkActiveIcon : bookmarkInactiveIcon
                    }
                    alt="Bookmark"
                    width={"24px"}
                  />
        ...
        >
          ...
          <Grid md={6.5}>
            <Stack spacing={4}>
              ...
              {/* About the Company */}
              <Stack spacing={2}>
                <Typography level="h2">About {job.postedBy.name}</Typography>
                <Typography level="body-lg" color="neutral">
              ...
              >
                <Grid md={8}>
                  <Stack spacing={1}>
                    <Typography level="h3">Apply Now</Typography>
                ...
                <Stack spacing={2}>
                  ...
                  {job.compensation && (
                    <Stack>
                      ...
                      <Typography level="title-md">
                        {formatCompenstation(job.compensation)}
                      </Typography>
                    </Stack>
                  )}
                  {/* Job Logistics */}
