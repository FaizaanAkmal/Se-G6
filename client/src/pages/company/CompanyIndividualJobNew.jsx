  ...
  return (
    <>
      ...
      <Stack spacing={0}>
        ...
        >
          <Grid xs={12} md={10.1} p={6} display="flex" flexDirection="column">
            <Stack spacing={"20px"}>
              {/* Job Title */}
        ...
        >
          ...
          <Grid md={3.5} paddingLeft={6}>
            ...
            <Grid>
              ...
              >
                <Stack spacing={1}>
                  <Typography level="h3">Close Job</Typography>
                  <Typography level="body-md" color="neutral">
                    Not hiring anymore? Close this job so that our talent can
                    know.
                  </Typography>
                </Stack>
                {/* Close Job Button */}
