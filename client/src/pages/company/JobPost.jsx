...
const JobPostPage = () => {
    ...
    const job = {
        ...
        status: "Closed",
        numApplicants: 3,
        description: "Seeking a Machine Learning Engineer to develop and implement ML models to solve complex problems and drive growth. Collaborate with cross-functional teams to design scalable solutions and deploy models into production.\n \n Responsibilities include : \n \n Develop and deploy ML models. \n  Collaborate with teams. \n Optimize models for performance. \n  Stay updated with ML advancements. \n \n  Apply now and be part of our journey!",
